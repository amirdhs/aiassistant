...
egw.extend('utils', egw.MODULE_GLOBAL, function () {
    ...
    function fallbackCopyTextToClipboard(event, target_element, text) {
        var _a, _b;
        const win = (_b = (_a = target_element === null || target_element === void 0 ? void 0 : target_element.ownerDocument.defaultView) !== null && _a !== void 0 ? _a : target_element.ownerDocument.parentWindow) !== null && _b !== void 0 ? _b : window;
    ...
    var utils = {
        ...
        getCache: function (_name) {
            if (typeof cache[_name] === 'undefined')
                cache[_name] = {};
            return cache[_name];
        },
        /**
        ...
        elemWindow: function (_elem) {
            var res = _elem.ownerDocument.parentNode ||
        ...
        storeWindow: function (appname, popup) {
            if (popup.opener && popup.opener.framework)
                popup.opener.framework.popups_garbage_collector();
