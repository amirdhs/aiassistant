...
var Required = /** @class */ (function (_super) {
     ...
     */
    Required.prototype.execute = function (modelValue, param, config) {
     ...
     */
    Required.getMessage = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, data.formControl.egw().lang("Field must not be empty !!!")];
            });
        });
    };
    return Required;
