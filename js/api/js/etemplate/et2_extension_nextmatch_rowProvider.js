...
exports.et2_nextmatch_rowTemplateWidget = exports.et2_nextmatch_rowWidget = exports.et2_nextmatch_rowProvider = void 0;
/*egw:uses
...
var et2_nextmatch_rowProvider = /** @class */ (function () {
    ...
    et2_nextmatch_rowProvider.prototype.getDataRow = function (_data, _row, _idx, _controller) {
        ...
        var _loop_1 = function () {
            ...
            if (typeof widget_class != "undefined") {
                widget = this_1._cloneWebComponent(entry, row, data);
                if (!widget) {
                ...
                nodes = new Array(entry.nodeFuncs.length);
            ...
            (_a = widget.transformAttributes) === null || _a === void 0 ? void 0 : _a.call(widget, data);
            // Translate
            if (widget_class) {
            ...
            var filtered = widget.deferredProperties ? Object.keys(data)
        ...
        var this_1 = this, entry, set, nodes;
        ...
        if (typeof _data.content["is_parent"] !== "undefined"
            ...
            if (top_controller.kept_expansion && expansion_index >= 0) {
                ...
                }, et2_dataview_view_grid_1.et2_dataview_grid.ET2_GRID_INVALIDATE_TIMEOUT);
            }
        }
        // Set the row data
     ...
     */
    et2_nextmatch_rowProvider.prototype._cloneWebComponent = function (entry, row, data) {
        // Widget was already cloned from original row, just get it
        var widget = entry.nodeFuncs[0](row);
        // Original widget
        var original = entry.nodeFuncs[0](this._dataRow);
    ...
    et2_nextmatch_rowProvider.prototype._createEmptyPrototype = function () {
        ...
        var placeholder = jQuery(document.createElement("td"))
            ...
            .css("height", "19px")
            .text(typeof label != "undefined" && label ? label : egw_global_1.egw().lang("No matches found"));
    ...
    et2_nextmatch_rowProvider.prototype._getVariableAttributeSet = function (_widget) {
        ...
        var process = function (_widget) {
            ...
            // Legacy
            if (_widget.instanceOf(et2_core_widget_1.et2_widget)) {
    ...
    et2_nextmatch_rowProvider.prototype._seperateWidgets = function (_varAttrs) {
        ...
        for (var i = 0; i < _varAttrs.length; i++) {
            ...
            if (widget.implements && widget.implements(et2_core_interfaces_1.et2_IDetachedDOM)) {
                ...
                for (var j = 0; j < _varAttrs[i].data.length /* && isDetachable*/; j++) {
                    ...
                    if (!supportsAttr) {
                        egw_global_1.egw.debug("warn", "et2_IDetachedDOM widget " +
    ...
    et2_nextmatch_rowProvider.prototype._stripTemplateRow = function (_rowTemplate) {
        ...
        for (var i = 0; i < _rowTemplate.seperated.remaining.length; i++) {
            ...
            // are very slow
            egw_global_1.egw.debug("warn", "Non-clonable widget '" + entry.widget._type + "' in dataview row - this " +
                "might be slow", entry);
            // Set the placeholder for the entry to null
            entry.placeholder = null;
            // Get the outer DOM-Node of the widget
            if (entry.widget.implements(et2_core_interfaces_1.et2_IDOMNode)) {
...
exports.et2_nextmatch_rowWidget = et2_nextmatch_rowWidget;
/**
 * @augments et2_widget
 */
...
exports.et2_nextmatch_rowTemplateWidget = et2_nextmatch_rowTemplateWidget;
