...
exports.et2_searchbox = exports.et2_textbox_ro = exports.et2_textbox = void 0;
/*egw:uses
...
var et2_searchbox = /** @class */ (function (_super) {
    ...
    et2_searchbox.prototype.createInputWidget = function () {
        ...
        if (!this.options.fix) {
            this.button = jQuery(document.createElement('button'))
                .css({ "background-image": egw_global_1.egw.image('search') })
                .click(function () {
        ...
        // input field
        this.search = et2_core_widget_1.et2_createWidget('textbox', { "blur": egw_global_1.egw.lang("search"),
    ...
    et2_searchbox.prototype._searchToggleState = function () {
        ...
        if (!this.get_value()) {
            ...
            this.button.set_statustext(egw_global_1.egw.lang("search for '%1'", this.get_value()));
        }
    };
    /**
...
exports.et2_searchbox = et2_searchbox;
