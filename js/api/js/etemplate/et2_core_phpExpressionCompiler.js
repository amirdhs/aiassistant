...
exports.et2_compilePHPExpression = void 0;
/*egw:uses
    et2_core_common;
*/
...
function et2_compilePHPExpression(_expr, _vars) {
    ...
    try {
        ...
        egw_global_1.egw.debug("log", "Compiled PHP " + _expr + " --> " + js);
    }
    catch (e) {
        // if expression does NOT compile use it literally and log a warning, but not stop execution
        egw_global_1.egw.debug("warn", "Error compiling PHP " + _expr + " --> using it literally (" +
...
exports.et2_compilePHPExpression = et2_compilePHPExpression;
var STATE_DEFAULT = 0;
var STATE_ESCAPED = 1;
