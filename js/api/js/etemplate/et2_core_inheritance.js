...
exports.ClassWithAttributes = exports.ClassWithInterfaces = void 0;
/*egw:uses
    et2_core_common;
*/
...
var ClassWithInterfaces = /** @class */ (function () {
    function ClassWithInterfaces() {
    }
    /**
     ...
     */
    ClassWithInterfaces.prototype.implements = function (_iface_name) {
        if (typeof et2_core_interfaces_1.et2_implements_registry[_iface_name] === 'function' &&
            et2_core_interfaces_1.et2_implements_registry[_iface_name](this)) {
            return true;
        }
        return false;
    };
     ...
     */
    ClassWithInterfaces.prototype.instanceOf = function (_class_or_interfacename) {
        if (typeof _class_or_interfacename === 'string') {
            return this.implements(_class_or_interfacename);
        }
        if (_class_or_interfacename === Et2Widget_1.Et2Widget) {
            return true;
        }
        return this instanceof _class_or_interfacename;
    };
    return ClassWithInterfaces;
}());
exports.ClassWithInterfaces = ClassWithInterfaces;
var ClassWithAttributes = /** @class */ (function (_super) {
    __extends(ClassWithAttributes, _super);
    ...
    ClassWithAttributes.prototype.getAttribute = function (_name) {
        if (typeof this.attributes[_name] != "undefined" &&
            ...
            egw_global_1.egw.debug("error", this, "Attribute '" + _name + "' does not exist!");
        }
    };
    /**
    ...
    ClassWithAttributes.prototype.setAttribute = function (_name, _value, _override) {
        if (typeof this.attributes[_name] != "undefined") {
            if (!this.attributes[_name].ignore) {
                ...
                var val = et2_core_common_1.et2_checkType(_value, this.attributes[_name].type, _name, this);
            ...
            egw_global_1.egw.debug("warn", this, "Attribute '" + _name + "' does not exist!");
        }
    };
    /**
    ...
    ClassWithAttributes.generateAttributeSet = function (widget, _attrs) {
        ...
        for (var key in _attrs) {
            if (typeof widget[key] != "undefined") {
                if (!widget[key].ignore) {
                    _attrs[key] = et2_core_common_1.et2_checkType(_attrs[key], widget[key].type, key, this);
                }
            }
            else {
                // Key does not exist - delete it and issue a warning
                delete (_attrs[key]);
                egw_global_1.egw.debug("warn", this, "Attribute '" + key +
        ...
        for (var key in widget) {
            if (typeof _attrs[key] == "undefined") {
                ...
                if (_default == et2_core_common_1.et2_no_init) {
                    _default = undefined;
                }
                _attrs[key] = _default;
            }
    ...
    ClassWithAttributes.extendAttributes = function (_parent, _attributes) {
        ...
        for (var key in attributes) {
            et2_core_common_1.et2_validateAttrib(key, attributes[key]);
        }
        return attributes;
    };
