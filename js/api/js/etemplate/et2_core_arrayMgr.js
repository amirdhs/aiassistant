...
var et2_core_phpExpressionCompiler_1 = require("./et2_core_phpExpressionCompiler");
/**
...
var et2_arrayMgr = /** @class */ (function () {
    ...
    function et2_arrayMgr(_data, _parentMgr) {
        ...
        if (typeof _data == "undefined" || !_data) {
            egw_global_1.egw.debug("log", "No data passed to content array manager.  Probably a mismatch between template namespaces and data.");
            _data = {};
        }
        ...
        if (pos_var >= 0 && (this.perspectiveData.row != null || !_ident.match(/\$\{?row\}?/))
            ...
            if (typeof et2_arrayMgr.compiledExpressions[_ident] == "undefined") {
                try {
                    if (this.perspectiveData.row == null) {
                        ...
                        // @ts-ignore
                        et2_arrayMgr.compiledExpressions[_ident] = et2_core_phpExpressionCompiler_1.et2_compilePHPExpression(_ident, ["cont", "_cont"]);
                    }
                    else {
                        // @ts-ignore
                        et2_arrayMgr.compiledExpressions[_ident] = et2_core_phpExpressionCompiler_1.et2_compilePHPExpression(_ident, ["row", "cont", "row_cont", "_cont"]);
                    }
                }
                catch (e) {
                    et2_arrayMgr.compiledExpressions[_ident] = null;
                    egw_global_1.egw.debug("error", "Error while compiling PHP->JS ", e);
                }
            }
            ...
            if (et2_arrayMgr.compiledExpressions[_ident]) {
                try {
                    ...
                    egw_global_1.egw.debug("log", typeof e == 'object' ? e.message : e);
                    _ident = null;
                }
            }
        }
    ...
    et2_arrayMgr.prototype.parseBoolExpression = function (_expression) {
        ...
        return et2_core_common_1.et2_evalBool(val);
    };
    /**
     * ?
     *
...
var et2_readonlysArrayMgr = /** @class */ (function (_super) {
    ...
    et2_readonlysArrayMgr.prototype.isReadOnly = function (_id, _attr, _parent) {
        ...
        if (typeof _attr != "undefined" && _attr !== null) {
            ...
            return typeof _attr === 'string' && this.expandName(_attr) === 'editable' ? 'editable' : et2_core_common_1.et2_evalBool(_attr);
        }
