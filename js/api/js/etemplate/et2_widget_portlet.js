...
var et2_portlet = /** @class */ (function (_super) {
    ...
    function et2_portlet(_parent, _attrs, _child) {
        ...
        _this.div = jQuery(document.createElement("div"))
            ...
            stop: function (event, ui) {
                ...
                }, null, et2_core_interfaces_1.et2_IResizeable);
            }
        });
        ...
        this.egw().jsonq("home.home_ui.ajax_set_properties", [this.id, settings, value, this.settings ? this.settings.group : false], function (data) {
            ...
            if (data.attributes.width || data.attributes.height) {
                ...
                try {
                    ...
                    egw_global_1.egw.debug('warn', e, this);
                }
            }
        }, this);
    ...
    et2_portlet.prototype.remove_portlet = function () {
        var self = this;
        Et2Dialog_1.Et2Dialog.show_dialog(function (button_id) {
            if (button_id != Et2Dialog_1.Et2Dialog.OK_BUTTON) {
                return;
            }
            ...
            self.destroy();
        }, this.egw().lang("Remove"), this.options.title, {}, Et2Dialog_1.Et2Dialog.BUTTONS_OK_CANCEL, Et2Dialog_1.Et2Dialog.QUESTION_MESSAGE);
    };
    /**
    ...
    et2_portlet.prototype.set_color = function (color) {
        ...
        this.header.css('color', (new colortranslator_1.ColorTranslator(this.header.css("backgroundColor"))).L > 50 ? 'black' : 'white');
    ...
    et2_portlet._attributes = {
        ...
        "edit_template": {
            ...
            "type": "string",
            "default": egw_global_1.egw.webserverUrl + "/home/templates/default/edit.xet"
        },
        "color": {
            "name": "Color",
        ...
        "rows": { "ignore": true, default: et2_core_common_1.et2_no_init },
        "cols": { "ignore": true, default: et2_core_common_1.et2_no_init },
        "resize_ratio": { "ignore": true, default: et2_core_common_1.et2_no_init },
        "row": {
            "name": "Row",
...
exports.et2_portlet = et2_portlet;
