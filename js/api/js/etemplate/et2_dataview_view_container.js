 ...
 * @augments Class
 */
var et2_dataview_container = /** @class */ (function (_super) {
    __extends(et2_dataview_container, _super);
    /**
    ...
    function et2_dataview_container(_parent) {
        ...
        _this._nodes = [];
        _this._inTree = false;
        _this._attachData = { "node": null, "prepend": false };
        _this._destroyCallback = null;
        _this._destroyContext = null;
        _this._height = -1;
        _this._index = 0;
        _this._top = 0;
        return _this;
    ...
    et2_dataview_container.prototype.getRange = function () {
        return et2_core_common_1.et2_bounds(this.getTop(), this.getBottom());
    };
    /**
...
}(et2_core_inheritance_1.ClassWithInterfaces));
