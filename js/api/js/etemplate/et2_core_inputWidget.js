...
var et2_inputWidget = /** @class */ (function (_super) {
    ...
    function et2_inputWidget(_parent, _attrs, _child) {
        ...
        _this._oldValue = et2_core_common_1.et2_no_init;
    ...
    et2_inputWidget.prototype.change = function (_node, _widget, _value) {
        ...
        if (valid && this.onchange) {
            if (typeof this.onchange == 'function') {
                ...
                return (et2_core_legacyJSFunctions_1.et2_compileLegacyJS(this.options.onchange, this, _node))();
            }
        }
        return valid;
    };
    ...
    et2_inputWidget.prototype.set_value = function (_value) {
        ...
        if (node) {
            ...
            if (this.isAttached() && this._oldValue !== et2_core_common_1.et2_no_init && this._oldValue !== _value) {
                jQuery(node).change();
            }
        }
     ...
     */
    et2_inputWidget.prototype.getValue = function (submit_value) {
        var node = this.getInputNode();
        if (node) {
