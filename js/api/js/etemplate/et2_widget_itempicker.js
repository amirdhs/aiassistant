...
var et2_itempicker = /** @class */ (function (_super) {
    ...
    et2_itempicker.prototype.createInputWidget = function () {
        ...
        this.clear
            ...
            .hide();
        // Action button
        this.button_action = et2_core_widget_1.et2_createWidget("button", {});
    ...
    et2_itempicker.prototype.query = function (request) {
        ...
        egw_global_1.egw.json("EGroupware\\Api\\Etemplate\\Widget\\ItemPicker::ajax_item_search", [this.current_app, '', request.term, request.options], this.queryResults, this, true, this).sendRequest();
    };
    /**
    ...
    et2_itempicker.prototype.transformAttributes = function (_attrs) {
        ...
        if (_attrs["application"]) {
            var apps = et2_core_common_1.et2_csvSplit(_attrs["application"], null, ",");
...
exports.et2_itempicker = et2_itempicker;
