...
exports.et2_widget = exports.et2_createWidget = exports.et2_register_widget = exports.et2_attribute_registry = exports.et2_registry = void 0;
/*egw:uses
    jsapi.egw;
    et2_core_xml;
    et2_core_common;
 ...
 * constructor.
 */
exports.et2_registry = {};
exports.et2_attribute_registry = {};
/**
...
function et2_register_widget(_constructor, _types) {
    "use strict";
    exports.et2_attribute_registry[_constructor.name] = et2_core_inheritance_1.ClassWithAttributes.buildAttributes(_constructor);
    ...
    for (var i = 0; i < _types.length; i++) {
        ...
        // types.
        if (exports.et2_registry[type]) {
            egw_global_1.egw.debug("warn", "Widget class registered for " + type +
                " will be overwritten.");
        }
        exports.et2_registry[type] = _constructor;
    }
}
...
function et2_createWidget(_name, _attrs, _parent) {
    ...
    if (typeof exports.et2_registry[_name] === "undefined") {
        if (window.customElements.get('et2-' + _name)) {
            return Et2Widget_1.loadWebComponent('et2-' + _name, _attrs, _parent);
        }
        else if (window.customElements.get(_name)) {
            return Et2Widget_1.loadWebComponent(_name, _attrs, _parent);
        }
    }
    ...
    if (typeof exports.et2_registry[nodeName] === "undefined") {
        nodeName = 'placeholder';
    }
    var constructor = exports.et2_registry[nodeName];
    if (readonly && typeof exports.et2_registry[nodeName + "_ro"] !== "undefined") {
        constructor = exports.et2_registry[nodeName + "_ro"];
    }
    // Do a sanity check for the attributes
    et2_core_inheritance_1.ClassWithAttributes.generateAttributeSet(exports.et2_attribute_registry[constructor.name], _attrs);
...
if (typeof window.et2_createWidget === 'undefined')
    window['et2_createWidget'] = et2_createWidget;
/**
...
var et2_widget = /** @class */ (function (_super) {
    ...
    function et2_widget(_parent, _attrs, _child) {
        ...
        _this.supportedWidgetClasses = [et2_widget, HTMLElement];
        if (_attrs["id"]) {
    ...
    et2_widget.prototype.destroy = function () {
        ...
        for (var key in this._mgrs) {
            if (this._mgrs[key] && ((_a = this._mgrs[key].getPerspectiveData()) === null || _a === void 0 ? void 0 : _a.owner) == this) {
    ...
    et2_widget.prototype.parseXMLAttrs = function (_attrsObj, _target, _proto) {
        ...
        for (var i = 0; i < _attrsObj.length; i++) {
            ...
            if (attrName == "options" && _proto.constructor.legacyOptions && _proto.constructor.legacyOptions.length > 0) {
                ...
                var attrs = exports.et2_attribute_registry[Object.getPrototypeOf(_proto).constructor.name] || {};
                ...
                for (var j = 0; j < splitted.length && j < legacy.length; j++) {
                    ...
                    if (typeof _target[legacy[j]] === "undefined") {
                        ...
                        var attr = exports.et2_attribute_registry[_proto.constructor.name][legacy[j]] || {};
                ...
                var attrs = exports.et2_attribute_registry[_proto.constructor.name] || {};
    ...
    et2_widget.prototype.createElementFromNode = function (_node, _name) {
        ...
        // check and return web-components in case widget is no longer available as legacy widget
        if (typeof exports.et2_registry[_nodeName] === "undefined" && window.customElements.get('et2-' + _nodeName)) {
            return Et2Widget_1.loadWebComponent('et2-' + _nodeName, _node, this);
        }
        // Get the constructor - if the widget is readonly, use the special "_ro"
        // constructor if it is available
        if (typeof exports.et2_registry[_nodeName] === "undefined" && typeof window.customElements.get(_nodeName) == "undefined") {
            _nodeName = 'placeholder';
        }
        var constructor = exports.et2_registry[_nodeName];
        if (readonly === true && typeof exports.et2_registry[_nodeName + "_ro"] != "undefined") {
            constructor = exports.et2_registry[_nodeName + "_ro"];
        }
        if (typeof window.customElements.get(_nodeName) !== "undefined") {
            widget = Et2Widget_1.loadWebComponent(_nodeName, _node, this);
        }
        else {
            ...
            et2_core_inheritance_1.ClassWithAttributes.generateAttributeSet(exports.et2_attribute_registry[constructor.name], attributes);
    ...
    et2_widget.prototype.loadingFinished = function (promises) {
        ...
        if (typeof result == "boolean" && result) {
            ...
            if (warn_if_deferred) {
                ...
                egw_global_1.egw.debug("warn", "Loading was deferred for widget %o, but creator is not checking.  Pass a list to loadingFinished().", this);
            }
        ...
        for (var key in _attrs) {
            if (typeof this.attributes[key] != "undefined" && !this.attributes[key].ignore && !(_attrs[key] == undefined)) {
                ...
                if (this.attributes[key].type == 'js' && typeof _attrs[key] == 'string') {
                    val = et2_core_legacyJSFunctions_1.et2_compileLegacyJS(val, this, this.implements(et2_core_interfaces_1.et2_IInputNode) ? this.getInputNode() :
                        (this.implements(et2_core_interfaces_1.et2_IDOMNode) ? this.getDOMNode() : null));
                }
    ...
    et2_widget.prototype.egw = function () {
        ...
        if (typeof this._egw === 'undefined') {
            ...
            return egw_global_1.egw('phpgwapi', wnd);
        }
        return this._egw;
    };
    /**
