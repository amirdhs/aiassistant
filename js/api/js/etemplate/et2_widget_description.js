...
var et2_description = /** @class */ (function (_super) {
    ...
    function et2_description(_parent, _attrs, _child) {
        ...
        _this.span = jQuery(document.createElement(_this.options["for"] ? "label" : "span"))
            .addClass("et2_label");
        et2_core_common_1.et2_insertLinkText(_this._parseText(_this.options.value), _this.span[0], _this.options.href ? _this.options.extra_link_target : '_blank');
    ...
    et2_description.prototype.doLoadingFinished = function () {
        ...
        if (this.options["for"] && ((for_widget = this.getParent().getWidgetById(this.options.for)) ||
            ...
            if (for_widget.dom_id || for_widget.getDOMNode().id) {
                ...
                if (for_widget.instanceOf(et2_core_interfaces_1.et2_IInputNode) && for_widget.getInputNode() && for_id !== for_widget.getInputNode().id) {
    ...
    et2_description.prototype.set_label = function (_value) {
        ...
        if (_value) {
            ...
            var parts = et2_core_common_1.et2_csvSplit(_value, 2, "%s");
    ...
    et2_description.prototype.getMedia = function (_value) {
        var base_url = egw_global_1.egw.webserverUrl.match(new RegExp(/^\//, 'ig')) ? egw_global_1.egw(window).window.location.origin : '';
        var mediaContent = [];
        if (_value) {
            mediaContent = [{
    ...
    et2_description.prototype.set_value = function (_value) {
        ...
        et2_core_common_1.et2_insertLinkText(this._parseText(_value), this.span[0], this.options.href ? this.options.extra_link_target : '_blank');
        ...
        if (this.options.extra_link_popup || this.options.mime) {
            ...
            $span.click(function (e) {
                if (self.options.expose_view && typeof self.options.mime != 'undefined' && self.options.mime.match(self.mime_regexp, 'ig')) {
                    ...
                    egw_global_1.egw(window).open_link(mime_data || href, self.options.extra_link_target, self.options.extra_link_popup, null, null, self.options.mime);
                }
                e.preventDefault();
                return false;
            });
    ...
    et2_description.prototype._parseText = function (_value) {
        if (this.options.href) {
            ...
            if (href.charAt(0) == '/') // link relative to eGW
             {
                href = egw_global_1.egw.link(href);
            }
            return [{
                    "href": href,
                    "text": _value
            ...
            return et2_core_common_1.et2_activateLinks(_value);
        }
        else {
            return [_value];
        }
    ...
    et2_description.legacyOptions = ["font_style", "href", "activate_links", "for",
