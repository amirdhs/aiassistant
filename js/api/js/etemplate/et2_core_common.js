...
exports.html_entity_decode = exports.et2_rangeSubstract = exports.et2_rangeEqual = exports.et2_rangeIntersectDir = exports.et2_rangeIntersect = exports.et2_bounds = exports.et2_range = exports.et2_hasChild = exports.et2_cloneObject = exports.et2_insertLinkText = exports.et2_activateLinks = exports.et2_csvSplit = exports.et2_substr = exports.et2_arrayIntKeys = exports.et2_arrayKeys = exports.et2_arrayValues = exports.et2_validateAttrib = exports.et2_no_init = exports.et2_checkType = exports.et2_form_name = exports.et2_evalBool = exports.et2_typeDefaults = exports.et2_validTypes = void 0;
 ...
 */
exports.et2_validTypes = ["boolean", "string", "rawstring", "html", "float", "integer", "any", "js", "dimension"];
/**
...
exports.et2_evalBool = et2_evalBool;
/**
...
exports.et2_form_name = et2_form_name;
/**
...
function et2_checkType(_val, _type, _attr, _widget) {
    ...
    function _err() {
        var res = exports.et2_typeDefaults[_type];
        if (typeof _val != "undefined" && _val) {
            egw_global_1.egw.debug("warn", "Widget %o: '" + _val + "' was not of specified _type '" +
    ...
    if (_val === exports.et2_typeDefaults[_type]) {
        return _val;
    }
        ...
        if (typeof _val == "string" && _val.substr(0, 4) == "app." && app) {
            ...
            if (typeof parent[func] == 'function') {
                try {
                    ...
                    egw_global_1.egw.debug('error', 'Function', _val);
                    return _err();
                }
            }
        }
...
exports.et2_checkType = et2_checkType;
/**
 ...
 */
exports.et2_no_init = new Object();
/**
...
function et2_validateAttrib(_id, _attrib) {
    ...
    if (typeof _attrib["name"] == "undefined") {
        _attrib["name"] = _id;
        egw_global_1.egw.debug("log", "Human name ('name'-Field) for attribute '" +
            _id + "' has not been supplied, set to '" + _id + "'");
    }
    if (typeof _attrib["description"] == "undefined") {
        _attrib["description"] = "";
        egw_global_1.egw.debug("log", "Description for attribute '" +
    ...
    if (typeof _attrib["type"] == "undefined") {
        ...
        if (exports.et2_validTypes.indexOf(_attrib["type"]) < 0) {
            egw_global_1.egw.debug("error", "Invalid type '" + _attrib["type"] + "' for attribute '" + _id +
                "' supplied.  Valid types are ", exports.et2_validTypes);
        }
    }
    // Set the defaults
    if (typeof _attrib["default"] == "undefined") {
        _attrib["default"] = exports.et2_typeDefaults[_attrib["type"]];
    }
}
exports.et2_validateAttrib = et2_validateAttrib;
/**
...
exports.et2_arrayValues = et2_arrayValues;
/**
...
exports.et2_arrayKeys = et2_arrayKeys;
...
exports.et2_arrayIntKeys = et2_arrayIntKeys;
/**
...
exports.et2_csvSplit = et2_csvSplit;
/**
...
exports.et2_activateLinks = et2_activateLinks;
/**
...
function et2_insertLinkText(_text, _node, _target) {
    if (!_node) {
        egw_global_1.egw.debug("warn", "et2_insertLinkText called without node", _text, _node, _target);
        return;
    }
    // Clear the node
    ...
    for (var i = 0; i < _text.length; i++) {
        ...
        if (typeof s == "string" || typeof s == "number") {
            ...
            if (!s.href) {
                egw_global_1.egw.debug("warn", "et2_activateLinks gave bad data", s, _node, _target);
                s.href = "";
            }
            ...
            if (s.href.substr(0, 7) == "mailto:" &&
                (egw_global_1.egw.user('apps').mail || egw_global_1.egw.user('apps').felamimail) &&
                egw_global_1.egw.preference('force_mailto', 'addressbook') != '1') {
                a.click(function (event) {
                    egw_global_1.egw.open_link(this.href);
                    return false;
                });
            }
            a.appendTo(_node);
...
exports.et2_insertLinkText = et2_insertLinkText;
/**
...
exports.et2_cloneObject = et2_cloneObject;
/**
...
exports.et2_hasChild = et2_hasChild;
/**
...
exports.et2_rangeIntersect = et2_rangeIntersect;
/**
...
exports.et2_rangeIntersectDir = et2_rangeIntersectDir;
/**
...
exports.et2_rangeEqual = et2_rangeEqual;
/**
...
exports.et2_rangeSubstract = et2_rangeSubstract;
/**
