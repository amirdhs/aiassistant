...
var et2_dataview_interfaces_1 = require("./et2_dataview_interfaces");
...
var et2_dataview_grid = /** @class */ (function (_super_1) {
    ...
    function et2_dataview_grid(_parent, _parentGrid, _egw, _rowProvider, _avgHeight) {
        ...
        // visible.
        _this._viewRange = et2_core_common_1.et2_range(0, 0);
    ...
    et2_dataview_grid.prototype.getVisibleIndexRange = function (_viewRange) {
        ...
        if (_viewRange) {
            ...
            vr = et2_core_common_1.et2_bounds(this._viewRange.top + et2_dataview_grid.ET2_GRID_VIEW_EXT, this._viewRange.bottom - et2_dataview_grid.ET2_GRID_VIEW_EXT);
        }
        ...
        return et2_core_common_1.et2_bounds(idxTop, idxBottom);
    };
    /**
    ...
    et2_dataview_grid.prototype.setScrollHeight = function (_height) {
        ...
        this.setViewRange(et2_core_common_1.et2_range(this._viewRange.top, this._scrollHeight));
    };
    /**
    ...
    et2_dataview_grid.prototype.makeIndexVisible = function (_idx) {
        ...
        var visibleRange = et2_core_common_1.et2_bounds(this._viewRange.top + et2_dataview_grid.ET2_GRID_VIEW_EXT, this._viewRange.bottom - et2_dataview_grid.ET2_GRID_VIEW_EXT);
    ...
    et2_dataview_grid.prototype._getElementRange = function (_idx) {
        ...
        if (elem instanceof et2_dataview_view_spacer_1.et2_dataview_spacer) {
            var avg = this.getAverageHeight();
            return et2_core_common_1.et2_range(elem.getTop() + avg * (elem.getIndex() - _idx), avg);
        }
    ...
    et2_dataview_grid.prototype._updateContainers = function () {
        var _loop_1 = function (i) {
            ...
            var hasIViewRange = !isSpacer && et2_core_interfaces_1.et2_implements_registry.et2_dataview_IViewRange(container, et2_dataview_interfaces_1.et2_dataview_IViewRange);
            ...
            if (isSpacer || hasIViewRange) {
                ...
                if (!et2_core_common_1.et2_rangeIntersect(this_1._viewRange, elemRange)) {
                    return "continue";
                }
                if (hasIViewRange) {
                    // Update the view range of the container
                    container.setViewRange(et2_core_common_1.et2_bounds(this_1._viewRange.top - elemRange.top, this_1._viewRange.bottom - elemRange.top));
                }
                else // This container is a spacer
                 {
                    ...
                    if (this_1._callback) {
                        var self_1 = this_1;
                        egw_global_1.egw.debug("log", "Dataview grid flag for update: ", { start: idxStart_1, end: idxEnd_1 });
    ...
    et2_dataview_grid.prototype._doInvalidate = function (_super) {
        ...
        if (this._invalidateCallback) {
            var range = this.getVisibleIndexRange(et2_core_common_1.et2_range(this.scrollarea.scrollTop(), this._scrollHeight));
        ...
        if (this._parentGrid == null) {
            this.scrollarea = jQuery(document.createElement("div"))
                ...
                e.data._scrollTimeout = window.setTimeout(jQuery.proxy(function () {
                    var newRange = et2_core_common_1.et2_range(this.scrollarea.scrollTop() - et2_dataview_grid.ET2_GRID_VIEW_EXT, this._scrollHeight + et2_dataview_grid.ET2_GRID_VIEW_EXT * 2);
                    if (!et2_core_common_1.et2_rangeEqual(newRange, this._viewRange)) {
