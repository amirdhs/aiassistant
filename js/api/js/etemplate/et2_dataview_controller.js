...
exports.et2_dataview_controller = exports.ET2_DATAVIEW_STEPSIZE = exports.ET2_DATAVIEW_FETCH_TIMEOUT = void 0;
 ...
 */
exports.ET2_DATAVIEW_FETCH_TIMEOUT = 50;
exports.ET2_DATAVIEW_STEPSIZE = 50;
/**
...
var et2_dataview_controller = /** @class */ (function () {
    ...
    et2_dataview_controller.prototype.update = function (clear) {
        ...
        this._queueFetch(et2_core_common_1.et2_bounds(range.top, clear ? 0 : range.bottom + 1), 0, true);
    };
    /**
    ...
    et2_dataview_controller.prototype.loadInitialData = function (uid_prefix, uid_key, data) {
        ...
        for (var key in data) {
            ...
            egw_global_1.egw.dataStoreUID(entry.uid, data[key]);
    ...
    et2_dataview_controller.prototype._gridCallback = function (_idxStart, _idxEnd) {
        ...
        if (needsData !== false) {
            this._queueFetch(et2_core_common_1.et2_bounds(needsData, _idxEnd + 1), needsData == _idxStart ? 0 : needsData > _idxStart ? 1 : -1, false);
        }
    };
    /**
    ...
    et2_dataview_controller.prototype._queueFetch = function (_range, _direction, _isUpdate) {
        ...
        if (this._queueTimer === null && !_isUpdate) {
            var self = this;
            egw_global_1.egw.debug('log', 'Dataview queue: ', _range);
            this._queueTimer = window.setTimeout(function () {
                self._flushQueue(false);
            }, exports.ET2_DATAVIEW_FETCH_TIMEOUT);
        }
        if (_isUpdate) {
    ...
    et2_dataview_controller.prototype._flushQueue = function (_isUpdate) {
        ...
        var marked = {};
        var r = _isUpdate ? 0 : Math.floor(exports.ET2_DATAVIEW_STEPSIZE / 2);
        ...
        for (var key in this._queue) {
            ...
            var c = 0;
            for (var i = b; i <= t && c < exports.ET2_DATAVIEW_STEPSIZE; i++) {
                if (typeof this._queue[i] == "undefined"
                    || this._queue[i] <= 1) {
        ...
        var arr = et2_core_common_1.et2_arrayIntKeys(marked).sort(function (a, b) { return a > b ? 1 : (a == b ? 0 : -1); });
        ...
        egw_global_1.egw.debug("log", "Dataview flush", fetchList);
        // Execute all queries
        ...
        if (this.self._rowCallback) {
            ...
            if (d > 0) {
                ...
                if (this.entry.idx == 0) {
                    ...
                    egw_global_1.egw.css(".subentry td div.innerContainer.level_" + d, "margin-right:" + (parseInt(indent.css("margin-right")) * d) + "px");
                    indent.remove();
                }
            }
            var links = null;
    ...
    et2_dataview_controller.prototype._destroyCallback = function (_row) {
        ...
        if (this.entry.row && selection && !egw_action_common_1.egwBitIsSet(selection.state, egw_action_constants_1.EGW_AO_STATE_SELECTED)) {
            var tr = this.entry.row.getDOMNode();
            this.self._selectionMgr._updateState(this.entry.uid, egw_action_constants_1.EGW_AO_STATE_NORMAL);
