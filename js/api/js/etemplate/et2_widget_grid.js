...
var et2_grid = /** @class */ (function (_super) {
    ...
    function et2_grid(_parent, _attrs, _child) {
        ...
        _this.wrapper = null;
        _this.sortablejs = null;
        // Create the table body and the table
        _this.table = jQuery(document.createElement("table"))
            .addClass("et2_grid");
        if (_attrs.class)
            _this.table.addClass(_attrs.class);
    ...
    et2_grid.prototype.destroy = function () {
        _super.prototype.destroy.call(this);
        this.cells.forEach(function (y) { return y.forEach(function (x) {
            var _a;
            (_a = x.td) === null || _a === void 0 ? void 0 : _a.remove();
            x.td = null;
            x.widget = null;
        }); });
        this.cells = [];
        this.rowData = [];
        this.colData = [];
        this.managementArray.forEach(function (n) {
            n.cell = null;
            n.widget = null;
        });
    ...
    et2_grid.prototype._fetchRowColData = function (columns, rows, colData, rowData) {
        ...
        et2_core_xml_1.et2_filteredNodeIterator(columns, function (node, nodeName) {
            var colDataEntry = this._getColDataEntry();
            // This cannot be done inside a nm, it will expand it later
            colDataEntry["disabled"] = nm ?
                et2_core_xml_1.et2_readAttrWithDefault(node, "disabled", "") :
                this.getArrayMgr("content")
                    .parseBoolExpression(et2_core_xml_1.et2_readAttrWithDefault(node, "disabled", ""));
            if (nodeName == "column") {
                colDataEntry["width"] = et2_core_xml_1.et2_readAttrWithDefault(node, "width", "auto");
                colDataEntry["class"] = et2_core_xml_1.et2_readAttrWithDefault(node, "class", "");
                colDataEntry["align"] = et2_core_xml_1.et2_readAttrWithDefault(node, "align", "");
                colDataEntry["span"] = et2_core_xml_1.et2_readAttrWithDefault(node, "span", "1");
        ...
        // Parse the rows tag
        et2_core_xml_1.et2_filteredNodeIterator(rows, function (node, nodeName) {
            ...
            if (nodeName == "row") {
                ...
                rowDataEntry["height"] = et2_core_xml_1.et2_readAttrWithDefault(node, "height", "auto");
                rowDataEntry["class"] = et2_core_xml_1.et2_readAttrWithDefault(node, "class", "");
                rowDataEntry["valign"] = et2_core_xml_1.et2_readAttrWithDefault(node, "valign", "");
                rowDataEntry["span"] = et2_core_xml_1.et2_readAttrWithDefault(node, "span", "1");
                rowDataEntry["part"] = et2_core_xml_1.et2_readAttrWithDefault(node, "part", "body");
                rowDataEntry["style"] = et2_core_xml_1.et2_readAttrWithDefault(node, "style", "");
                ...
                if (content_1.data[rowIndex]) {
                    ...
                    var check_1 = function (node, nodeName) {
                        if (nodeName == 'box' || nodeName == 'hbox' || nodeName == 'vbox') {
                            return et2_core_xml_1.et2_filteredNodeIterator(node, check_1, this);
                        }
                        content_1.perspectiveData.row = rowIndex;
                        for (var attr in node.attributes) {
                            var value = et2_core_xml_1.et2_readAttrWithDefault(node, node.attributes[attr].name, "");
                            ...
                            if (value.indexOf('@') > 0 || value.indexOf('$') > 0) {
                                ...
                                if (rowIndex >= 1000) {
                                    egw_global_1.egw.debug("error", "Problem in autorepeat fallback: too many rows for '%s'.  Use a nextmatch, or start debugging.", value);
                                }
                                return;
                            }
                        }
                    };
                    et2_core_xml_1.et2_filteredNodeIterator(this_1.lastRowNode, check_1, this_1);
                    cont = false;
    ...
    et2_grid.prototype._fillCells = function (cells, columns, rows) {
        ...
        et2_core_xml_1.et2_filteredNodeIterator(columns, function (node, nodeName) {
            ...
            var y = 0;
            if (nodeName == "column") {
                et2_core_xml_1.et2_filteredNodeIterator(node, _readColNode, this);
            }
            else {
        ...
        et2_core_xml_1.et2_filteredNodeIterator(rows, function (node, nodeName) {
            readRowNode = function _readRowNode(node, nodeName) {
                ...
                if (node.getAttribute("class")) {
                    var widget_class = (this.getArrayMgr("content").expandName(node.getAttribute("class")) || "")
            ...
            if (nodeName == "row") {
                ...
                if (!disabled) {
                    et2_core_xml_1.et2_filteredNodeIterator(node, readRowNode, this);
                }
            }
            else {
        ...
        for (y; y < h; y++) {
            x = 0;
            et2_core_xml_1.et2_filteredNodeIterator(this.lastRowNode, readRowNode, this);
        }
        // Reset
        for (var name in this.getArrayMgrs()) {
    ...
    et2_grid.prototype.loadFromXML = function (_node) {
        ...
        var rowsElems = et2_core_xml_1.et2_directChildrenByTagName(_node, "rows");
        var columnsElems = et2_core_xml_1.et2_directChildrenByTagName(_node, "columns");
    ...
    et2_grid.prototype.set_sortable = function (sortable) {
        var self = this;
        var tbody = this.getDOMNode().getElementsByTagName('tbody')[0];
        ...
        this.sortablejs = new sortable_complete_esm_js_1.default(tbody, {
    ...
    et2_grid.prototype._link_actions = function (actions) {
        ...
        // @ts-ignore
        var objectManager = egw_action_1.egw_getAppObjectManager(true, this.getInstanceManager().app);
        ...
        if (widget_object == null || widget_object.manager != this._actionManager) {
            ...
            // objects
            widget_object = objectManager.insertObject(false, new egw_action_1.egwActionObject(this.id, objectManager, new et2_core_DOMWidget_1.et2_action_object_impl(this).getAOI(), this._actionManager || objectManager.manager.getActionById(this.id) || objectManager.manager));
        }
    ...
    et2_grid.prototype.getRow = function (_sender) {
        ...
        for (var r = 0; r < this.cells.length; ++r) {
            ...
            var _loop_2 = function () {
                ...
                if (!found)
                    row[c].widget.iterateOver(function (_widget) {
                        if (_widget === _sender)
                            found = true;
                    });
                if (found) {
