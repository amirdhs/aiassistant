...
var et2_dataview = /** @class */ (function () {
    ...
    et2_dataview.prototype._buildHeader = function () {
        ...
        for (var i = 0; i < this.columns.length; i++) {
            ...
            if (this.columnMgr && this.columnMgr.getColumnById(i)) {
                ...
                if (this.columnMgr.getColumnById(i).visibility === et2_dataview_model_columns_1.et2_dataview_column.ET2_COL_VISIBILITY_ALWAYS_NOSELECT) {
                    column.addClass('noResize');
                }
            }
            // make column resizable
            var enc_column = self.columnMgr.getColumnById(col.id);
            if (enc_column.visibility !== et2_dataview_model_columns_1.et2_dataview_column.ET2_COL_VISIBILITY_ALWAYS_NOSELECT) {
    ...
    et2_dataview.prototype._getDepVars = function () {
        if (typeof this.scrollbarWidth === 'undefined') {
            ...
            jQuery(egw_global_1.egw.top.document.getElementsByTagName("body")[0])
                .append(clone);
