...
exports.et2_action_object_impl = exports.et2_surroundingsMgr = exports.et2_DOMWidget = void 0;
/*egw:uses
    et2_core_interfaces;
    et2_core_widget;
...
var et2_DOMWidget = /** @class */ (function (_super) {
    ...
    et2_DOMWidget.prototype.destroy = function () {
        ...
        if (this._actionManager) {
            var app_om = egw_action_1.egw_getObjectManager(this.egw().getAppName(), false, 1);
            if (app_om) {
    ...
    et2_DOMWidget.prototype.doLoadingFinished = function () {
        ...
        if (this.getParent() && this.getParent().implements(et2_core_interfaces_1.et2_IDOMNode)) {
    ...
    et2_DOMWidget.prototype.get_tab_info = function () {
        ...
        for (var i = 0; i < tabbox.tabData.length; i++) {
            ...
            // @ts-ignore
            if ((_a = tabbox.tabData[i].contentDiv) === null || _a === void 0 ? void 0 : _a.contains(this.getDOMNode(this) || this)) {
        ...
        for (var i = tabbox.tabData.length - 1; i >= 0; i--) {
            if (template && template.id &&
                (template.id === tabbox.tabData[i].id || ((_b = tabbox.tabData[i].contentDiv) === null || _b === void 0 ? void 0 : _b.getWidgetById(template.id)) !== null)) {
                return tabbox.tabData[i];
            }
        }
        // Fallback
    ...
    et2_DOMWidget.prototype.getDOMIndex = function () {
        if (this.getParent()) {
            ...
            egw_global_1.egw.debug('warn', 'No Array.indexOf(), falling back to looping. ');
    ...
    et2_DOMWidget.prototype._link_actions = function (actions) {
        ...
        var objectManager = egw_action_1.egw_getAppObjectManager(true);
        var widget_object = objectManager.getObjectById(this.id);
        if (widget_object == null) {
            // Add a new container to the object manager which will hold the widget
            // objects
            widget_object = objectManager.insertObject(false, new egw_action_1.egwActionObject(this.id, objectManager, (new et2_action_object_impl(this)).getAOI(), this._actionManager || objectManager.manager.getActionById(this.id) || objectManager.manager));
        }
        else {
...
var et2_surroundingsMgr = /** @class */ (function (_super) {
    ...
    et2_surroundingsMgr.prototype._rebuildContainer = function () {
        ...
        if (this._widgetSurroundings.length > 0) {
            ...
            var hasPlaceholder = et2_core_common_1.et2_hasChild(this._widgetSurroundings, this._widgetPlaceholder);
...
exports.et2_surroundingsMgr = et2_surroundingsMgr;
/**
...
var et2_action_object_impl = /** @class */ (function () {
    function et2_action_object_impl(_widget, _node) {
        ...
        this.aoi = new egw_action_1.egwActionObjectInterface();
        ...
        this.aoi.doTriggerEvent = function (_event, _data) {
            switch (_event) {
                case egw_action_constants_1.EGW_AI_DRAG_OVER:
                    jQuery(this.node).addClass("ui-state-active");
                    break;
                case egw_action_constants_1.EGW_AI_DRAG_OUT:
