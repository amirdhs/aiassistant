...
var et2_extension_nextmatch_actions_js_1 = require("./et2_extension_nextmatch_actions.js");
...
var et2_nextmatch_controller = /** @class */ (function (_super) {
    ...
    function et2_nextmatch_controller(_parentController, _egw, _execId, _widget, _parentId, _grid, _rowProvider, _actionLinks, _objectManager, _actions) {
        ...
        _this.setRowCallback(_this._nmRowCallback);
        _this.setLinkCallback(_this._nmLinkCallback);
    ...
    et2_nextmatch_controller.prototype._initActions = function (_actions) {
        ...
        this._actionManager.setDefaultExecute(function (_action, _senders, _target) {
            ...
            et2_extension_nextmatch_actions_js_1.nm_action(_action, _senders, _target, ids);
        });
        ...
        var gom = egw_action_1.egw_getObjectManager(this.egw.appName, true, 1);
        if (this._objectManager == null) {
            this._objectManager = gom.addObject(new egw_action_1.egwActionObjectManager(uid, this._actionManager));
        ...
        this._objectManager.flags = this._objectManager.flags
            | egw_action_constants_1.EGW_AO_FLAG_DEFAULT_FOCUS | egw_action_constants_1.EGW_AO_FLAG_IS_CONTAINER;
    ...
    et2_nextmatch_controller.prototype._init_links_dnd = function () {
        ...
        if (!drop_cancel) {
            ...
            drop_cancel = mgr.addAction('drop', 'egw_cancel_drop', this.egw.lang('Cancel'), egw_global_1.egw.image('cancel'), function () { }, true);
            drop_cancel.set_group('99');
            drop_cancel.acceptedTypes = drop_cancel.acceptedTypes.concat(Object.keys(egw_global_1.egw.user('apps')).concat(['link', 'file']));
            this._actionLinks.push(drop_cancel.id);
        }
        // Check if this app supports linking
        if (!egw_global_1.egw.link_get_registry(this.dataStorePrefix || this.egw.appName, 'query') ||
            egw_global_1.egw.link_get_registry(this.dataStorePrefix || this.egw.appName, 'title')) {
            if (drop_action) {
                drop_action.remove();
        ...
        if (drop_action == null) {
            ...
            drop_action = mgr.addAction('drop', 'egw_link_drop', this.egw.lang('Create link'), egw_global_1.egw.image('link'), function (action, source, dropped) {
                // Extract link IDs
                var links = [];
                var id = '';
     ...
     * be properly freed.
     */
    et2_nextmatch_controller.prototype._nmRowCallback = function (_data, _tr, _idx, _entry) {
     ...
     */
    et2_nextmatch_controller.prototype._nmLinkCallback = function (_data, _idx, _uid) {
        if (_uid.trim() != "") {
