...
var et2_hbox = /** @class */ (function (_super) {
    ...
    et2_hbox.prototype.loadFromXML = function (_node) {
        ...
        et2_core_xml_1.et2_filteredNodeIterator(_node, function (_node) {
    ...
    et2_hbox.prototype.assign = function (_obj) {
        ...
        // assigned
        this.alignData = et2_core_common_1.et2_cloneObject(_obj.alignData);
        this._buildAlignCells();
    ...
    et2_hbox.prototype.getDOMNode = function (_sender) {
        ...
        if (_sender != this && this.alignData.hasAlign) {
            ...
            var align = ((_sender === null || _sender === void 0 ? void 0 : _sender.implements(et2_core_interfaces_1.et2_IAligned)) ? _sender === null || _sender === void 0 ? void 0 : _sender.get_align() : "left");
...
et2_core_widget_1.et2_register_widget(et2_hbox, ["hbox", "old-hbox"]);
