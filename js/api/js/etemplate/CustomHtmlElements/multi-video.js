...
var multi_video = /** @class */ (function (_super) {
     ...
     */
    multi_video.prototype.load = function () {
        this._videos.forEach(function (_item) { _item.node.load(); });
    };
    /**
    ...
    Object.defineProperty(multi_video.prototype, "src", {
        ...
        set: function (_value) {
            ...
            (_b = Array.from((_a = this._wrapper) === null || _a === void 0 ? void 0 : _a.children)) === null || _b === void 0 ? void 0 : _b.forEach(function (_ch) {
                _ch.remove();
            });
