/**
 * EGroupware AI Assistant - Client-side JavaScript (EGroupware Compatible)
 * 
...
AIAssistantApp.prototype = {
     ...
     */
    add_tool_call: function(tool_call) {
        var container = this.et2.getWidgetById('messages_container');
        if (!container) return;
     ...
     */
    handle_clear_response: function(data) {
        if (data.success) {
            // Clear the display
            var container = this.et2.getWidgetById('messages_container');
            if (container) {
